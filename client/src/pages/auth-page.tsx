              ...
              <div className="mt-8">
                ...
                <div className="grid grid-cols-2 gap-3 mt-6">
                  <Button 
                    ...
                    onClick={() => {
                      alert("Google sign-in will be implemented soon. Please use email/password login for now.");
                    }}
                    type="button"
                  >
                  ...
                  <Button 
                    ...
                    className="flex items-center justify-center"
                    onClick={() => {
                      alert("Apple sign-in will be implemented soon. Please use email/password login for now.");
                    }}
                    type="button"
                  >
