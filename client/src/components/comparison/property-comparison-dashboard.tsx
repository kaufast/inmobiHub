...
import { ChevronLeft, ChevronRight, X, Plus, ArrowDownUp, Share, Printer, Camera, Download } from 'lucide-react';
        ...
        <ScrollArea className="w-full pb-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 min-w-fit">
            {sortedProperties.map((property) => (
              <div key={property.id} className="comparison-card bg-white rounded-xl shadow-md overflow-hidden border border-primary-100 flex flex-col">
                ...
                <div className="p-5 flex flex-col flex-grow">
                  ...
                  {activeCategory === 'overview' && (
                    <div className="space-y-4 flex-grow">
                      <p className="text-primary-700">{truncateText(property.description, 150)}</p>
