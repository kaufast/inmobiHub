...
ALTER TYPE public.message_status OWNER TO melchor;
...
ALTER TYPE public.property_type OWNER TO melchor;
...
ALTER TYPE public.role OWNER TO melchor;
...
ALTER TYPE public.subscription_tier OWNER TO melchor;
...
ALTER TYPE public.tour_status OWNER TO melchor;
...
ALTER TYPE public.tour_type OWNER TO melchor;
...
ALTER TABLE public.chat_analytics OWNER TO melchor;
...
ALTER TABLE public.chat_analytics_id_seq OWNER TO melchor;
...
ALTER TABLE public.favorites OWNER TO melchor;
...
ALTER TABLE public.favorites_id_seq OWNER TO melchor;
...
ALTER TABLE public.messages OWNER TO melchor;
...
ALTER TABLE public.messages_id_seq OWNER TO melchor;
...
ALTER TABLE public.neighborhoods OWNER TO melchor;
...
ALTER TABLE public.neighborhoods_id_seq OWNER TO melchor;
...
ALTER TABLE public.properties OWNER TO melchor;
...
ALTER TABLE public.properties_id_seq OWNER TO melchor;
...
ALTER TABLE public.property_drafts OWNER TO melchor;
...
ALTER TABLE public.property_drafts_id_seq OWNER TO melchor;
...
ALTER TABLE public.property_tours OWNER TO melchor;
...
ALTER TABLE public.property_tours_id_seq OWNER TO melchor;
...
ALTER TABLE public.search_history OWNER TO melchor;
...
ALTER TABLE public.search_history_id_seq OWNER TO melchor;
...
ALTER TABLE public.session OWNER TO melchor;
...
ALTER TABLE public.suggested_questions OWNER TO melchor;
...
ALTER TABLE public.suggested_questions_id_seq OWNER TO melchor;
...
ALTER TABLE public.users OWNER TO melchor;
...
ALTER TABLE public.users_id_seq OWNER TO melchor;
